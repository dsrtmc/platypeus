...
export type CreateRaceMutation = { __typename?: 'Mutation', createRace: { __typename?: 'CreateRacePayload', race?: { __typename?: 'Race', id: any, private: boolean } | null } };
...
export type GetRacesQuery = { __typename?: 'Query', races?: { __typename?: 'RacesConnection', edges?: Array<{ __typename?: 'RacesEdge', node: { __typename?: 'Race', id: any, createdAt: any, finished: boolean, racers?: { __typename?: 'RacersConnection', edges?: Array<{ __typename?: 'RacersEdge', node: { __typename?: 'Racer', wpm: number, user: { __typename?: 'User', username: string } } }> | null } | null, host: { __typename?: 'User', username: string } } }> | null } | null };
...
export type UserPage_GetUserQuery = { __typename?: 'Query', user?: { __typename?: 'User', id: any, username: string, createdAt: any, updatedAt: any } | null };

export type OnChatboxEventSubscriptionVariables = Exact<{
  chatboxId: Scalars['UUID']['input'];
  messagesFirst?: InputMaybe<Scalars['Int']['input']>;
}>;
...
export type OnRaceEventSubscription = { __typename?: 'Subscription', onRaceEvent: { __typename?: 'Race', id: any, mode: string, modeSetting: number, started: boolean, running: boolean, finished: boolean, content: string, chatboxId: any, startTime: any, racers?: { __typename?: 'RacersConnection', edges?: Array<{ __typename?: 'RacersEdge', node: { __typename?: 'Racer', id: any, finished: boolean, wpm: number, wordsTyped: number, user: { __typename?: 'User', id: any, username: string } } }> | null } | null, host: { __typename?: 'User', id: any, username: string } } };
...
export const OnChatboxEventDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"subscription","name":{"kind":"Name","value":"OnChatboxEvent"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"chatboxId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"messagesFirst"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"onChatboxEvent"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"chatboxId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"chatboxId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"messages"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"first"},"value":{"kind":"Variable","name":{"kind":"Name","value":"messagesFirst"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"edges"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"node"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"author"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"username"}}]}},{"kind":"Field","name":{"kind":"Name","value":"content"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}}]}}]}}]}}]}}]}}]} as unknown as DocumentNode<OnChatboxEventSubscription, OnChatboxEventSubscriptionVariables>;
